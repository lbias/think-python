...
import turtle
from e3_polygon import circle, arc
...
if __name__ == '__main__':
    ...
    for f in [draw_p, draw_y, draw_t, draw_h, draw_o, draw_n, draw_, draw_i, draw_s, draw_, draw_t, draw_h, draw_e, draw_, draw_b, draw_e, draw_s, draw_t]:
        f(bob, size)
        skip(bob, size)
